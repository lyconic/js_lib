...
Object.extend(String.prototype, (function() {
  ...
  **/
  ...
  /**
   *   String#toDate() -> Date | null
   *
   *   First tries to convert to Date using constructor.
   *   If that fails, tries parsing. Otherwise returns null.
  **/
  function toDate() {
    var date = new Date(this);
    if (date.invalid()) date = Date.parse(this);
    return date;
  }
