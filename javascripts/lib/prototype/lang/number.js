...
Object.extend(Number.prototype, (function() {
  ...
  **/
  ...
  /** alias of: Number#toPaddedString
   *  Number#pad(length[, radix]) -> String
  **/
  var pad = toPaddedString;
  ...
  **/
  ...
  /**
   *  Number#toFixed([precision = 2]) -> String
   *
   *  Returns number as a fixed-length decimal to the given
   *  precision.
  **/
